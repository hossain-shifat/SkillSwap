...
const CourseDetail = () => {
    ...
    const singleCourse = data.find(course => course.skillId.toString() === id)
            ...
            <div>
                ...
                <div className="max-w-[350px] sm:max-w-[700px] md:max-w-[800px] lg:max-w-[900px] mx-auto mt-5 px-3">
                    <div className="pb-2 border-gray-300">
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="border-b pb-2 border-gray-300">
                    ...
                    <div>
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="pb-2 border-gray-300 my-4 flex flex-col sm:flex-row gap-2 justify-between">
                            ...
                            <h2 className="font-semibold text-xl">Slot Available: <span className="text-red-500">{singleCourse.slotsAvailable}</span></h2>
                        </motion.div>
                    </div>
                    <div>
