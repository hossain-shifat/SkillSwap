...
const HowItWorks = () => {
    return (
        <div>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 my-10 gap-5 max-w-[1200px] mx-auto text-center *:gap-3 *:text-center">
                ...
                <motion.div className="md:col-span-full md:mx-auto" initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.1 }} whileHover={{ scale: 1.05, y: -5, boxShadow: "0px 10px 20px rgba(0,0,0,0.1)" }}>
