    ...
    return (
        <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 my-10 gap-5 max-w-[1200px] mx-auto text-center *:gap-3">
                ...
                <div className="flex flex-col justify-center items-center border border-gray-100 shadow-sm rounded-xl p-5 md:p-7 lg:p-10 mx-10 md:mx-5 lg:col-span-full lg:mx-auto">
